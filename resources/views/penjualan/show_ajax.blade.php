            ...
            <div class="modal-body">
                <table class="table table-sm table-bordered table-striped">
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tr><th class="test-right col-3">Nama Customer : </th><td class="col-9">{{ $penjualan->pembeli }}</td></tr>
                        <tr><th class="test-right col-3">PIC : </th><td class="col-9">{{ $penjualan->user->nama }}</td></tr>
